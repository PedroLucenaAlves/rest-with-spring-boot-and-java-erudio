...
public class DozerConverterTest {
    ...
    @Test
    public void parseEntityToVOTest() { //inseri mocks de entidades
        PersonVO output = DozerMapper.parseObject(inputObject.mockEntity(), PersonVO.class);
        assertEquals(Long.valueOf(0L), output.getId()); //verifica se o primeiro valor e igual ao segundo, se nao for igual vai falhar
